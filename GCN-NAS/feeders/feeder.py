...
class Feeder(Dataset):
    ...
    def load_data(self):
        # data: N C V T M
        if self.label_path[16:21]=='train':
            self.data_path='./data/train.npy'
            self.label_path='./data/train_label.pkl'
            filename_path='./data/train_filename.pkl'
        elif self.label_path[16:19]=='val':
            self.data_path='./data/test.npy'
            self.label_path='./data/test_label.pkl'
            filename_path='./data/test_filename.pkl'
        try:
            ...
            with open(filename_path,'rb') as f:
                self.sample_name= pickle.load(f, encoding='latin1')
